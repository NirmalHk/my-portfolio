...
export const productProjects: Project[] = [
  {
    ...
    title: 'Duolingo: Product Strategy Teardown',
    ...
    outcomes: [
      ...
      'Improve voice recognition accuracy for inclusivity',
      'Expand progress tracking beyond XP and streaks'
    ],
    link: 'https://www.linkedin.com/posts/nirmal-harikrishnan_duo-activity-7345475185585606657-SK8Y?utm_source=share&utm_medium=member_desktop&rcm=ACoAACrDQp4Box7sCP-7KBDk_QzSMuKU2L8zfbo'
  },
  {
    id: 'saas-platform-launch',
    title: 'Coming Soon!',
    description: 'A new case study will be added here shortly.',
    longDescription: 'Hint: Related to habit loops :)',
    image: 'https://placehold.co/600x400/111/fff?text=Coming+Soon',
    technologies: ['TBA'],
    outcomes: [

    ],
    link: 'https://www.linkedin.com/in/nirmal-harikrishnan/'
  },
  {
    id: 'ecommerce-optimization',
    title: 'Coming Soon!',
    description: 'A new case study will be added here shortly.',
    longDescription: 'Product Teardown incoming!',
    image: 'https://placehold.co/600x400/111/fff?text=Coming+Soon',
    technologies: ['TBA'],
    outcomes: [
